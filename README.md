...
- 안드로이드 스마트폰 갤러리에 저장된 이미지 및 동영상 파일들의 썸네일을 확인하고, 이를 PC에서 편하게 복사할 수 있는 서비스 입니다.
